...
public class CryogenusOre extends Block {

	private final int minXP;
	private final int maxXP;

	public CryogenusOre(int minXP, int maxXP, int harvestLevel) {
		super(AbstractBlock.Properties.of(Material.METAL, MaterialColor.COLOR_GRAY).strength(6f, 1200f)
